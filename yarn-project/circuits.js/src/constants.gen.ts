...
export const DEPLOYER_CONTRACT_ADDRESS = 9256947041321027089533495832830405543710101516429552788062967841445602134030n;
export const REGISTERER_CONTRACT_ADDRESS = 867409746588255642605883457564767101821478729272763062990600291025697803994n;
export const GAS_TOKEN_ADDRESS = 8777298866013239306861859762114222884687709421566494727011568767822269644915n;
...
export const COMBINED_ACCUMULATED_DATA_LENGTH = 364;
...
export const PUBLIC_ACCUMULATED_DATA_LENGTH = 1279;
export const PUBLIC_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 3565;
export const KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 417;
